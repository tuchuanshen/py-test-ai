...
class ListenerManager:
    ...
    def _default_message_handler(self, contact_name: str,
                                 messages: List) -> None:
        """
        默认消息处理函数
        :param contact_name: 联系人名称
    ...
    def _individual_listener_worker(self,
                                    contact_name: str,
    ...
    def start_individual_listening(self,
        ...
        if contact_name:
            ...
            # 启动线程
            thread = threading.Thread(target=self._individual_listener_worker,
    ...
    def stop_individual_listening(self,
    ...
    def set_message_handler(self, contact_name: str,
