    ...
    def _init_default_prompts(self):
        ...
        self.add_prompt_template(
            ...
            ChatPromptTemplate.from_messages([
                ("system", "你是一个有帮助的AI助手。根据我提供的这段对话信息，帮助我下一句该如何回复。回答的内容要尽量短小，简练。回答的语气一定要温柔谦和、轻松、略带文采。例如不需要回答：我轻抚你的额头，柔声说：“别恼，我为你煮碗醒酒汤，再给你讲个温柔的故事。”而是直接返 “回别恼，我为你煮碗醒酒汤，再给你讲个温柔的故事”"),
                ("human", "{input}"),
            ])
        )
